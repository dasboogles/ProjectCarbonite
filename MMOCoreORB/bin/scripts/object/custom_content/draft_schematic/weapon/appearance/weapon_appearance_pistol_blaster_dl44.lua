object_draft_schematic_weapon_appearance_weapon_appearance_pistol_blaster_dl44 = object_draft_schematic_weapon_appearance_shared_weapon_appearance_pistol_blaster_dl44:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "D144 Blaster Pistol",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_pistol_blaster_dl44, "object/draft_schematic/weapon/appearance/weapon_appearance_pistol_blaster_dl44.iff")
