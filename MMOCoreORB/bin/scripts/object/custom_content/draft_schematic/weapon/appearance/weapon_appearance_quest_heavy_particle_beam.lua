object_draft_schematic_weapon_appearance_weapon_appearance_quest_heavy_particle_beam = object_draft_schematic_weapon_appearance_shared_weapon_appearance_quest_heavy_particle_beam:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Quest Heavy Particle Beam",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_quest_heavy_particle_beam, "object/draft_schematic/weapon/appearance/weapon_appearance_quest_heavy_particle_beam.iff")
