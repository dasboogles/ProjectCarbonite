object_draft_schematic_weapon_appearance_weapon_appearance_pistol_geo_sonic_blaster = object_draft_schematic_weapon_appearance_shared_weapon_appearance_pistol_geo_sonic_blaster:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Geo Sonic Blaster Pistol",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_pistol_geo_sonic_blaster, "object/draft_schematic/weapon/appearance/weapon_appearance_pistol_geo_sonic_blaster.iff")
