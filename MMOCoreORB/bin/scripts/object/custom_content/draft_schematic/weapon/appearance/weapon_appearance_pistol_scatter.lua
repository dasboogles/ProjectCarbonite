object_draft_schematic_weapon_appearance_weapon_appearance_pistol_scatter = object_draft_schematic_weapon_appearance_shared_weapon_appearance_pistol_scatter:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_pistol_scatter, "object/draft_schematic/weapon/appearance/weapon_appearance_pistol_scatter.iff")
