object_draft_schematic_weapon_appearance_weapon_appearance_quest_pistol_launcher = object_draft_schematic_weapon_appearance_shared_weapon_appearance_quest_pistol_launcher:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Quest Pistol Launcher",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_quest_pistol_launcher, "object/draft_schematic/weapon/appearance/weapon_appearance_quest_pistol_launcher.iff")
