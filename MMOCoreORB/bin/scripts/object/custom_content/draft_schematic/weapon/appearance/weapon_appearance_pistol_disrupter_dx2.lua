object_draft_schematic_weapon_appearance_weapon_appearance_pistol_disrupter_dx2 = object_draft_schematic_weapon_appearance_shared_weapon_appearance_pistol_disrupter_dx2:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Dx2 Disrupter Pistol",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_appearance_weapon_appearance_pistol_disrupter_dx2, "object/draft_schematic/weapon/appearance/weapon_appearance_pistol_disrupter_dx2.iff")
