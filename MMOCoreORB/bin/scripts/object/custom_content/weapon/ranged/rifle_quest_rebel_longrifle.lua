...
object_weapon_ranged_rifle_rifle_quest_rebel_longrifle = object_weapon_ranged_rifle_shared_rifle_quest_rebel_longrifle:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_rifle_rifle_quest_rebel_longrifle, "object/weapon/ranged/rifle/rifle_quest_rebel_longrifle.iff")
