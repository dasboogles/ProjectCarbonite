...
object_draft_schematic_weapon_rifle_light_blaster_imperial_scout_carbine = object_draft_schematic_weapon_shared_rifle_light_blaster_imperial_scout_carbine:new {
   ...
   resourceTypes = {"steel", "iron", "metal", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/component/weapon/shared_blaster_rifle_barrel.iff", "object/tangible/component/weapon/shared_scope_weapon.iff", "object/tangible/component/weapon/shared_stock.iff"},
   resourceQuantities = {65, 25, 12, 3, 1, 1, 1}, -- Moved 1 power handler to the end
