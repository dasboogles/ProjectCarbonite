...
object_draft_schematic_weapon_component_blaster_power_handler_advanced = object_draft_schematic_weapon_component_shared_blaster_power_handler_advanced:new {
   ...
   resourceTypes = {"petrochem_inert_polymer", "copper", "ore_carbonate", "aluminum", "gas_reactive", "object/tangible/component/weapon/shared_base_blaster_power_handler_enhancement.iff"},
