...
object_draft_schematic_droid_component_item_storage_module_6 = object_draft_schematic_droid_component_shared_item_storage_module_6:new {
   ...
   resourceTypes = {"steel", "ore_extrusive", "gas_inert", "metal", "object/tangible/component/item/shared_electronics_gp_module.iff", "object/tangible/component/item/shared_electronics_memory_module.iff"},
