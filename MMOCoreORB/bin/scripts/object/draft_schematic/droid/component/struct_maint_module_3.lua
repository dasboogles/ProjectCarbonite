...
object_draft_schematic_droid_component_struct_maint_module_3 = object_draft_schematic_droid_component_shared_struct_maint_module_3:new {
   ...
   resourceTypes = {"aluminum", "gemstone_crystalline", "object/tangible/component/item/shared_electronics_gp_module.iff", "object/tangible/component/item/shared_electronics_memory_module.iff"},
