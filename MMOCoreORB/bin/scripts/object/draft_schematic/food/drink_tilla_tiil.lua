...
object_draft_schematic_food_drink_tilla_tiil = object_draft_schematic_food_shared_drink_tilla_tiil:new {
   ...
   resourceTypes = {"object/tangible/food/crafted/shared_drink_alcohol.iff", "gas_inert", "gas_inert", "gas_inert", "object/tangible/component/food/base/shared_drink_container_base.iff", "object/tangible/food/crafted/additive/shared_additive_heavy.iff"},
