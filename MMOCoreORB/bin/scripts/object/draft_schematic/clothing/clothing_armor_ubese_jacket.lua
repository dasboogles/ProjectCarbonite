...
object_draft_schematic_clothing_clothing_armor_ubese_jacket = object_draft_schematic_clothing_shared_clothing_armor_ubese_jacket:new {
   ...
   -- ingredientTitleNames = {"auxilary_coverage", "body", "liner", "hardware_and_attachments", "binding_and_reinforcement", "padding", "armor", "load_bearing_harness", "reinforcement"},
   -- ingredientSlotType = {0, 0, 0, 0, 0, 0, 1, 1, 1},
   -- resourceTypes = {"iron", "steel", "hide_leathery", "steel", "petrochem_inert_polymer", "hide_wooly", "object/tangible/component/armor/shared_armor_segment_ubese.iff", "object/tangible/component/clothing/shared_fiberplast_panel.iff", "object/tangible/component/clothing/shared_reinforced_fiber_panels.iff"},
