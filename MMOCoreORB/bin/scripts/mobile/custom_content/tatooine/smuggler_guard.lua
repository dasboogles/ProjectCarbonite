smuggler_guard = Creature:new {
	customName = "a smuggler loadmaster",
	socialGroup = "thug",
	faction = "thug",
	level = 10,
	chanceHit = 0.56,
...
CreatureTemplates:addCreatureTemplate(smuggler_guard, "smuggler_guard")
