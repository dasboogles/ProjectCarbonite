smuggler_cargo_handler = Creature:new {
	customName = "a smuggler cargo handler",
	socialGroup = "thug",
	faction = "thug",
	level = 6,
	chanceHit = 0.26,
...
CreatureTemplates:addCreatureTemplate(smuggler_cargo_handler, "smuggler_cargo_handler")
