...
rebelRewardData = {
	...
	weaponsArmor = {
		...
		armor_marine_gloves_gcw = { index=4, type=factionRewardType.armor, display="@wearables_name:armor_marine_gloves", item="object/tangible/wearables/armor/marine/armor_marine_gloves_gcw.iff",cost=50}, 
		armor_marine_chest_plate_gcw = { index=5, type=factionRewardType.armor, display="@wearables_name:armor_marine_chest_plate", item="object/tangible/wearables/armor/galactic_marine/armor_galactic_marine_chest_plate_gcw.iff",cost=500},
		armor_marine_helmet_gcw = { index=6, type=factionRewardType.armor, display="@wearables_name:armor_marine_helmet", item="object/tangible/wearables/armor/marine/armor_marine_helmet_gcw.iff",cost=50},
		...
		armor_marine_bracer_l_gcw = { index=14, type=factionRewardType.armor, display="@wearables_name:armor_marine_bracer_l", item="object/tangible/wearables/armor/marine/armor_marine_bracer_l_gcw.iff",cost=50},
		armor_marine_belt_gcw = { index=15, type=factionRewardType.armor, display="@wearables_name:armor_marine_belt", item="object/tangible/wearables/armor/marine/armor_marine_belt_gcw.iff",cost=50},
...
imperialRewardData = {
	weaponsArmorList = {
		...
		"rocket_launcher", "mine_drx", "mine_xg","lance_staff_metal", "armor_stormtrooper_backpack",
	},
	...
	weaponsArmor = {
		...
		armor_stormtrooper_chest_plate_gcw = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_chest_plate", item="object/tangible/wearables/armor/stormtrooper/armor_stormtrooper_chest_plate_gcw.iff", cost=500},
		armor_stormtrooper_helmet_gcw = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_helmet", item="object/tangible/wearables/armor/stormtrooper/armor_stormtrooper_helmet_gcw.iff", cost=50},
		armor_stormtrooper_leggings_gcw = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_leggings", item="object/tangible/wearables/armor/stormtrooper/armor_stormtrooper_leggings_gcw.iff",cost=50},
		armor_stormtrooper_bracer_l_gcw = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_bracer_l", item="object/tangible/wearables/armor/stormtrooper/armor_stormtrooper_bracer_l_gcw.iff",cost=50},
		armor_stormtrooper_bracer_r_gcw = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_bracer_r", item="object/tangible/wearables/armor/stormtrooper/armor_stormtrooper_bracer_r_gcw.iff",cost=50},
		armor_stormtrooper_gloves_gcw = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_gloves", item="object/tangible/wearables/armor/stormtrooper/armor_stormtrooper_gloves_gcw.iff",cost=50},
		armor_stormtrooper_utility_belt_gcw = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_utility_belt", item="object/tangible/wearables/armor/stormtrooper/armor_stormtrooper_utility_belt_gcw.iff",cost=50},
		pistol_power5 = { type=factionRewardType.weapon, display="@weapon_name:pistol_power5", item="object/weapon/ranged/pistol/pistol_power5.iff", cost=50},
		carbine_e11 = { type=factionRewardType.weapon, display="@weapon_name:carbine_e11", item="object/weapon/ranged/carbine/carbine_e11.iff", cost=50},
		sword_02 = { type=factionRewardType.weapon, display="@weapon_name:sword_02", item="object/weapon/melee/sword/sword_02.iff", cost=50},
		rocket_launcher = { type=factionRewardType.weapon, display="@weapon_name:rocket_launcher", item="object/weapon/ranged/heavy/heavy_rocket_launcher.iff", cost=250},
		lance_staff_metal = { type=factionRewardType.weapon, display="@weapon_name:lance_staff_metal", item="object/weapon/melee/polearm/lance_staff_metal.iff", cost=50},
		mine_drx = { type=factionRewardType.weapon, display="@weapon_name:mine_drx", item="object/weapon/mine/wp_mine_drx55.iff", cost=500},
		mine_xg = { type=factionRewardType.weapon, display="@weapon_name:mine_xg", item="object/weapon/mine/wp_mine_xg.iff", cost=500},
	},
