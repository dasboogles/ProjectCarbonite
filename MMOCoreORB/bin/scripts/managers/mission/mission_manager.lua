...
bh_targets_at_mission_level = {
	...
	level3 = { --level 51 - 200 (current highest is 120, probe droids will only have a 5% chance to find targets over level 190)
		...
		"bh_dark_adept", --level 240
		"bh_dark_knight" --level 325
	}
}
...
-- Default is 30 minutes // changed to 3hours -> 1 hour 30minutes
playerBountyKillBuffer = 90 * 60 * 1000 -- Buffer before player bounty can be put back on terminal after target is killed, set 0 to disable
